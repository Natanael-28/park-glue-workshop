...
CREATE EXTERNAL TABLE IF NOT EXISTS workshop_gold.dim_product (
  ...
  product_sk  bigint)
STORED AS PARQUET
LOCATION 's3://spark-glue-workshop-datalake-sdaq-01/gold/dim_product/';
...
CREATE EXTERNAL TABLE IF NOT EXISTS workshop_gold.dim_customer (
  ...
  customer_sk bigint)
STORED AS PARQUET
LOCATION 's3://spark-glue-workshop-datalake-sdaq-01/gold/dim_customer/';
...
CREATE EXTERNAL TABLE IF NOT EXISTS workshop_gold.dim_date (
  ...
  date_sk  int)
STORED AS PARQUET
LOCATION 's3://spark-glue-workshop-datalake-sdaq-01/gold/dim_date/';
...
CREATE EXTERNAL TABLE IF NOT EXISTS workshop_gold.fact_sales (
  ...
  is_return    boolean)
STORED AS PARQUET
LOCATION 's3://spark-glue-workshop-datalake-sdaq-01/gold/fact_sales/';
